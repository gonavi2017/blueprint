...
import (
	...
	"github.com/gonavi2017/blueprint/model/clearing"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = clearing.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := clearing.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = clearing.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = clearing.DeleteSoft(db, lastID, userID)
	if err != nil {
