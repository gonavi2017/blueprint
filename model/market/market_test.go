...
import (
	...
	"github.com/gonavi2017/blueprint/model/market"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = market.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := market.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = market.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = market.DeleteSoft(db, lastID, userID)
	if err != nil {
