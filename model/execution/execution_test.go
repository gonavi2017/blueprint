...
import (
	...
	"github.com/gonavi2017/blueprint/model/execution"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = execution.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := execution.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = execution.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = execution.DeleteSoft(db, lastID, userID)
	if err != nil {
