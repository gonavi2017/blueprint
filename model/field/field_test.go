...
import (
	...
	"github.com/blue-jay/blueprint/model/field"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = field.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := field.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = field.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = field.DeleteSoft(db, lastID, userID)
	if err != nil {
