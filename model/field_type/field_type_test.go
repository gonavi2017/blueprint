...
import (
	...
	"github.com/blue-jay/blueprint/model/field_type"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = field_type.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := field_type.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = field_type.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = field_type.DeleteSoft(db, lastID, userID)
	if err != nil {
