...
import (
	...
	"github.com/blue-jay/blueprint/model/lot"
...
func TestComplete(t *testing.T) {
	...
	// Create a record
	result, err = lot.Create(db, data, userID)
	if err != nil {
	...
	// Select a record
	record, _, err := lot.ByID(db, lastID, userID)
	if err != nil {
	...
	// Update a record
	result, err = lot.Update(db, dataNew, lastID, userID)
	if err != nil {
	...
	result, err = lot.DeleteSoft(db, lastID, userID)
	if err != nil {
